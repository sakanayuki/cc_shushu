...
const SLIDERS: SliderDef[] = [
  ...
  { section: 'PHYSICS', label: 'frictionAir', min: 0.005, max: 0.1, step: 0.001, get: (p) => p.physics.frictionAir, set: (p, v) => { p.physics.frictionAir = v; } },
  { section: 'PHYSICS', label: 'restitution', min: 0, max: 0.9, step: 0.05, get: (p) => p.physics.restitution, set: (p, v) => { p.physics.restitution = v; } },
  { section: 'PHYSICS', label: 'wallRestitution', min: 0, max: 0.9, step: 0.05, get: (p) => p.physics.wallRestitution, set: (p, v) => { p.physics.wallRestitution = v; } },
  { section: 'CARD', label: 'thrownRadius', min: 20, max: 80, step: 1, get: (p) => p.card.thrownRadius, set: (p, v) => { p.card.thrownRadius = v; } },
